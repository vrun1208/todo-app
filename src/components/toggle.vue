...
<label class="switch">
    ...
    <span class="slider round" v-if="this.theme == 'lightMode'"> </span>
    <span class="slider round" v-else> </span>  
</label>  
</div>
</template>
...
export default {
    ...
    mounted() {
        ...
        document.documentElement.setAttribute('data-theme', localTheme); // updates the data-theme 
    },
methods:{
    toggleTheme() {
